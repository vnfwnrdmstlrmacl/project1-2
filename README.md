...
```mermaid
flowchart LR
    subgraph OnPrem["🏢 Onprem-Zone"]
        direction TB
        ProxyVIP["Proxy VIP<br/>10.2.2.254"]
        Proxy1["Proxy1<br/>10.2.2.20"]
        Proxy2["Proxy2<br/>10.2.2.21"]
        DBVIP["DB VIP<br/>10.2.3.254"]
        DBA["DB-A<br/>10.2.3.2"]
        DBS["DB-S<br/>10.2.3.3"]
        Etcd1["Etcd-1<br/>10.2.3.20"]
        Etcd2["Etcd-2<br/>10.2.3.21"]
        Etcd3["Etcd-3<br/>10.2.3.22"]
